...
func NewGreetServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) GreetServiceClient {
	...
	greetServiceMethods := File_greet_proto.Services().ByName("GreetService").Methods()
	return &greetServiceClient{
		greet: connect.NewClient[GreetRequest, GreetResponse](
			httpClient,
...
type greetServiceClient struct {
	greet *connect.Client[GreetRequest, GreetResponse]
	ping  *connect.Client[PingRequest, PingResponse]
}

// Greet calls greet.v1.GreetService.Greet.
func (c *greetServiceClient) Greet(ctx context.Context, req *connect.Request[GreetRequest]) (*connect.Response[GreetResponse], error) {
	return c.greet.CallUnary(ctx, req)
}

// Ping calls greet.v1.GreetService.Ping.
func (c *greetServiceClient) Ping(ctx context.Context, req *connect.Request[PingRequest]) (*connect.Response[PingResponse], error) {
...
func (UnimplementedGreetServiceHandler) Greet(context.Context, *connect.Request[GreetRequest]) (*connect.Response[GreetResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("greet.v1.GreetService.Greet is not implemented"))
}

func (UnimplementedGreetServiceHandler) Ping(context.Context, *connect.Request[PingRequest]) (*connect.Response[PingResponse], error) {
