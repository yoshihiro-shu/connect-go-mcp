...
func TestGenerate(t *testing.T) {
	...
	// 期待されるファイル名を確認
	expectedFileName := "greet_mpcserver.go"
	...
	assert.Contains(t, content, `// Code generated by connect-go-mpc DO NOT EDIT.`)
...
func TestGenerateMatchesBufOutput(t *testing.T) {
	...
	expectedContent, err := os.ReadFile("../../testdata/greet/gen/greet_mpcserver.go")
	...
	file := rsp.File[0]
	assert.Equal(t, "greet_mpcserver.go", file.GetName())
